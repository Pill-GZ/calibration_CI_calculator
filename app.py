                ...
                ui.column(
                    ...
                    ui.card(
                        ...
                        ui.tooltip(
                            ...
                            "The total number of samples, integers only",
                            id="n_input_tooltip",
                            placement="right",
                        ),
    ...
    def observed_expected_inputs():
        ...
        return ui.TagList(
            ui.tooltip(
                ...
                "The total number of observed (positive) events among the n samples, fractional values allowed",
                id="o_input_tooltip",
                placement="right",
            ),
            ui.tooltip(
                ...
                "The total number of expected (positive) events among the n samples, fractional values allowed",
                id="e_input_tooltip",
                placement="right",
            ),
        )
